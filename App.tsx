...
type Tab = 'marocain' | 'mre' | 'etranger';
...
const styles = StyleSheet.create({
  ...
  zelligeLine2: { height: 3, backgroundColor: Colors.secondary, opacity: 0.7 },
  content: { flex: 1 },
  tabBar: {
    flexDirection: 'row',
    backgroundColor: '#fff',
  ...
  tabButton: { flex: 1, alignItems: 'center', paddingVertical: 6, position: 'relative' },
